...
function initializeAutoTrimps() {
    ...
    loadPageVariables();
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://rawgit.com/kevrlet/AutoTrimps/NewUI.js')._;
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://rawgit.com/kevrlet/AutoTrimps/Graphs.js')._;
